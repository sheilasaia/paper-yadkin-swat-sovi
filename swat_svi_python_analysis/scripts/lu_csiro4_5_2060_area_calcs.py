...
# USFS Forest Futures cornerstone C (= CSIRO 4.5)
...
yadluC2060_ras=r'...\paper-yadkin-swat-svi-study\swat_svi_python_analysis\data\spatial\yadluC_2060'
...
for sub in subs_list:
    ...
    arcpy.gp.ExtractByMask_sa(yadluC2060_ras,mask_filename,outputlu_filename)
...
# export to csv file
outputdf_filename='...\paper-yadkin-swat-svi-study\swat_svi_r_analysis\data\tabular\lu_csiro4_5_2060_allsubs.csv'
