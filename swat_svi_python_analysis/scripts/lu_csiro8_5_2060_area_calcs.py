...
# USFS Forest Futures cornerstone B (= CSIRO 8.5)
...
yadluB2060_ras=r'...\paper-yadkin-swat-svi-study\swat_svi_python_analysis\data\spatial\yadluB_2060'
...
for sub in subs_list:
    ...
    arcpy.gp.ExtractByMask_sa(yadluB2060_ras,mask_filename,outputlu_filename)
...
# export to csv file
outputdf_filename='...\paper-yadkin-swat-svi-study\swat_svi_r_analysis\data\tabular\lu_csiro8_5_2060_allsubs.csv'
