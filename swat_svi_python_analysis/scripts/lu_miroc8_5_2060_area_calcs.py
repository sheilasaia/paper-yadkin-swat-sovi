...
# USFS Forest Futures cornerstone A (= MIROC 8.5)
...
yadluA2060_ras=r'...\paper-yadkin-swat-svi-study\swat_svi_python_analysis\data\spatial\yadluA_2060'
...
for sub in subs_list:
    ...
    arcpy.gp.ExtractByMask_sa(yadluA2060_ras,mask_filename,outputlu_filename)
...
# export to csv file
outputdf_filename='...\paper-yadkin-swat-svi-study\swat_svi_r_analysis\data\tabular\lu_miroc8_5_2060_allsubs.csv'
