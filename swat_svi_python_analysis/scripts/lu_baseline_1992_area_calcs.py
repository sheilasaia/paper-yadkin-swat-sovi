...
# basline from NLCD 1992 that was reclassified to be comparible to 2060 classes
...
yadlu1992_ras=r'...\paper-yadkin-swat-svi-study\swat_svi_python_analysis\data\spatial\yadlurec_1992'
...
for sub in subs_list:
    ...
    arcpy.gp.ExtractByMask_sa(yadlu1992_ras,mask_filename,outputlu_filename)
...
# export to csv file
outputdf_filename='...\paper-yadkin-swat-svi-study\swat_svi_r_analysis\data\tabular\lu_baseline_1992_allsubs.csv'
