# model_freq_calcs_one_rch function

# purpose: generate log-Pearson type III model curve for high flow frequency analysis (one reach)
...
model_hiflow_freq_calcs_one_rch <- function(obs_hiflow_freq_calcs_one_rch_df, kn_table, model_p_list) {
  ...
  # remove outliers
  obs_temp_data <- remove_outliers(obs_hiflow_freq_calcs_one_rch_df, kn_table)
